...
**Type**: SPA  
**Description**: Responsible SPA has 4 routes (React Router), css animation ( + WOW.JS), parallax effect, components as carousel, accordion (React Bootstrap, React Slick), smooth scrolling to 2 sections, Google Map    
